namespace BlazorRepl.Client.Components
{
    ...
    public class DepProvider : IRemoteDependencyProvider
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            //var nuspecStream = await this.client.GetStreamAsync($"https://api.nuget.org/v3-flatcontainer/{libraryIdentity.Name}/{libraryIdentity.Version}/{libraryIdentity.Name}.nuspec");
